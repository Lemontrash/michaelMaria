...
In accordance with the WordPress policy, the content spinning scripts can not be hosted at wordpress.org. Thus you have to manually download the spinners.zip archive from [this page](http://www.cyberseo.net/cyberseo-lite), unpack it and upload the contained spinners.php file to the /wp-content/plugins/cybersyn folder of your site.

Don't worry, it's a freeware GPL script, so you don't have to pay for anything. Just download it, unpack and upload into the same folder at your site where cybersyn.php is located, and the content spinning feature will become instantly available.
